...
#   economic_strength_dict = {}
    ...
    update_weights(health_dict, 'accumulated_cases_score', 0.04 )
    update_weights(health_dict, 'accumulated_recoveries_score', 0.02 )
    update_weights(health_dict, 'accumulated_hospitalized_score', 0.08 )
...
def get_map_df():
    return df_scored[["lat", "lon", "Loneliness", "Health", "Economic_Strength"]]
#########################################################################################################
