...
def main():
    ...
    #     uploaded_file = None
        with about_header:
            ...
            about_home_subheader("<FONT COLOR="red"><b>SoCity's main goal is to enable the authorities to make data-driven decisions about social issues and turn the spotlight on households at risk, so they can help them.</b> </FONT>")
