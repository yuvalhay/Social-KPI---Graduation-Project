...
def main():
    ...
    #     uploaded_file = None
        with about_header:
            ...
            st.text("During the project we came to an understanding that “Risk” is a combination of three social KPIs which are Loneliness, Health and Economic Strength. ")
